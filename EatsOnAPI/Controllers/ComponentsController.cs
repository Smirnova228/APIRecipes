...
namespace EatsOnAPI.Controllers
{
    ...
    public class ComponentsController : ControllerBase
    {
        ...
        public ComponentsController(EatsOnContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != component.NumberComponent)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Component>> PostComponent(Component component)
        {
          if (_context.Components == null)
          {
              return Problem("Entity set 'EatsOnContext.Components'  is null.");
          }
            _context.Components.Add(component);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetComponent", new { id = component.NumberComponent }, component);
        }
        ...
        {
            return (_context.Components?.Any(e => e.NumberComponent == id)).GetValueOrDefault();
        }
    }
}
